...
var AdItemDirective=function(e){function a(a,t,n){console.log(e.Crawl().getData()),t.find("canvas").bind("mouseenter",function(){}),t.find("canvas").bind("mouseleave",function(){t.find("canvas").css("opacity","1")});var o=t.find("canvas")[0],r=o.getContext("2d");r.globalCompositeOperation="source-over";var i=new Image,c=new Image;i.onload=function(){r.drawImage(i,0,0),0==a.out&&r.drawImage(c,0,0)},i.src=e.Crawl().getData().links[a.out],c.src=e.Crawl().getData().templateDir.Banner}var t={restrict:"AE",templateUrl:"app/components/adItem/adItemDirective.html",link:a,scope:{out:"@",model:"=",remove:"&"}};return t};angular.module("app").directive("adItem",["adItemService",AdItemDirective]);
